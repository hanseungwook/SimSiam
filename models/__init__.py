...
from .simclr import SimCLR, SimCLRJoint, SimCLRMI, SimCLRGram, SimCLRKL, SimCLRVAE
...
def get_model(model_cfg):    
    ...
    elif model_cfg.name == 'simclr_vae':
        model = SimCLRVAE(get_backbone(model_cfg.backbone), model_cfg.proj_dim)
