...
# Gram ratio loss with negatives as 1 other mismatched pair (randomly assigned per batch)
def gram_loss_1neg(z1, z2, temperature=0.5):
    N, Z = z1.shape 
    device = z1.device 
    ...
    z1_shuff = z1[torch.randperm(z1.shape[0])]
    z2_shuff = z2[torch.randperm(z2.shape[0])]
