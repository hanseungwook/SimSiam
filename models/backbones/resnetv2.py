...
def _ResNet(arch, block, num_blocks, num_classes=10, zero_init_residual=False, pretrained=False, **kwargs):
    model = ResNet(block, num_blocks, num_classes, zero_init_residual, **kwargs)
