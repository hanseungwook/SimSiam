...
class ResNet(nn.Module):
    ...
    def __init__(self, block, layers, num_classes=10, zero_init_residual=False,
        ...
        self.conv1 = nn.Conv2d(6, self.inplanes, kernel_size=3, stride=1, padding=1, bias=False)
        ## END
...
def _resnet(arch, block, layers, pretrained, progress, device, **kwargs):
    ...
    if pretrained:
        ...
        state_dict = torch.load(script_dir + '/state_dicts/cifar10/'+arch+'.pt', map_location=device)
