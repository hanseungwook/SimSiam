...
def resnet8(**kwargs):
    return _ResNet('resnet8', 8, [16, 16, 32, 64], 'basicblock', **kwargs)


def resnet14(**kwargs):
    return _ResNet('resnet14', 14, [16, 16, 32, 64], 'basicblock', **kwargs)


def resnet20(**kwargs):
    return _ResNet('resnet20', 20, [16, 16, 32, 64], 'basicblock', **kwargs)


def resnet32(**kwargs):
    return _ResNet('resnet32', 32, [16, 16, 32, 64], 'basicblock', **kwargs)


def resnet44(**kwargs):
    return _ResNet('resnet44', 44, [16, 16, 32, 64], 'basicblock', **kwargs)


def resnet56(**kwargs):
    return _ResNet('resnet56', 56, [16, 16, 32, 64], 'basicblock', **kwargs)


def resnet110(**kwargs):
    return _ResNet('resnet110', 110, [16, 16, 32, 64], 'basicblock', **kwargs)


def resnet8x4(**kwargs):
    return _ResNet('resnet8x4', 8, [32, 64, 128, 256], 'basicblock', **kwargs)


def resnet32x4(**kwargs):
    return _ResNet('resnet32x4', 32, [32, 64, 128, 256], 'basicblock', **kwargs)
