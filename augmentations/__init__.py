...
def get_aug(dataset, name='simsiam', image_size=224, train=True, train_classifier=None):
    ...
    if train==True:
        if name == 'simsiam' or name == 'simsiam_kd' or name == 'simsiam_adv' or name == 'simsiam_joint' or name =='simsiam_mi':
        ...
        elif name == 'simclr' or name == 'simclr_joint' or name =='simclr_mi' or name ==  'simclr_gram':
